...
class TestGameController(unittest.TestCase):
    ...
    def test_play_game_discover_bomb(self, mock_database_manager, mock_board, mock_view):
        ...
        mock_view.return_value.display_message.assert_any_call("¡Boom! Has perdido. Puntos totales: 0")
    ...
    def test_play_game_win(self, mock_database_manager, mock_board, mock_view):
        ...
        mock_view.return_value.display_message.assert_any_call("¡Felicidades! Has ganado con 110 puntos.")
        mock_database_manager.return_value.insert_player.assert_called_once_with("TestPlayer", 110)
